 ...
 * @author gxlzlihao
 */
public class proInfoTag extends BodyTagSupport {
    private int pid;
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            JspWriter out = pageContext.getOut();
            ProductInfoBean pib = new ProductInfoBean(jdbc_url, pid);
            out.println(pib.getXml());
        }catch(Exception e){
    ...
    private void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("Error in proInfoTag tag", ex);
    }
