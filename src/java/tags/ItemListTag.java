 ...
 * @author gxlzlihao
 */
public class ItemListTag extends BodyTagSupport {
    ...
    public int doEndTag() throws JspException {
        ...
        try{
            ...
            Collection ilb = (Collection)sess.getAttribute("newItemList");
            Iterator iter = ilb.iterator();
            out.append("<newItemList>");
            while(iter.hasNext()){
                //add each already added item to the output
                ib = (ItemBean)iter.next();
                out.append(ib.getXml());
            }
            out.append("</newItemList>");
    ...
    private void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("Error in ItemListTag tag", ex);
    }
