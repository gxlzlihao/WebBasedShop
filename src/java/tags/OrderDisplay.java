 ...
 * @author gxlzlihao
 */
public class OrderDisplay extends BodyTagSupport {
    private String xslt;
    ...
    private void writeTagBodyContent(JspWriter out, BodyContent bodyContent)throws IOException{
        ...
        Source xmlSrc = new StreamSource(new java.io.StringReader(bodyStr));
        ...
        bodyContent.writeOut(out);
            ...
            //
            out.println("Transformer Factory error: "+tce.getMessage());
        }catch(TransformerException te){
            //
            out.println("Transformation error: "+te.getMessage());
    ...
    private void handleBodyContentException(Exception ex) throws JspException {
        ...
        throw new JspException("Error in OrderDisplay tag", ex);
    }
